...
#VERIFICA SE O CODIGO DO CARGO ESTA NA BASE A PARTIR DA JUNÇÃO DE GRUPO E NUMERO CARGO
    ...
    def insert_or_update_servidor(self):
        ...
        if (self.funcao == "DAS") or (self.funcao == "FIN") or (self.funcao == "FGR") and (self.dataSaidaFuncao == "00000000"):
            tem_funcao_s = True
        else:
            tem_funcao_s = False
        if ((self.siglaNovaFuncao == "DAS") or (self.siglaNovaFuncao == "FIN") or (self.siglaNovaFuncao == "FGR")) and (self.dataSaidaNovaFuncao == "00000000"):
